...
class RewardMathFn(RewardFn):
    ...
    def __call__(self, input: RewardInput) -> RewardOutput:
        ...
        for ground_truth in processed_ground_truths:
            ...
            model_answer = [model_answer] if isinstance(model_answer, str) else model_answer
            is_correct = labeling_responses(model_answer, ground_truth)[0]
            if is_correct:
...
def reward_fn_math_verify(data_source: str, llm_solution: str, ground_truth: Union[str, List[str]], extra_info={}, **kwargs):
